...
class AuditParser(HTMLParser):
    def __init__(self):
        super().__init__()
        self.ids=[]; self.links=[]; self.resources=[]; self.target_blank=[]; self.meta={}; self.title=False
...
def main():
    ...
    required_meta=["description","viewport","og:title","og:description","og:image","twitter:card"]
    ...
    for required in [ROOT/"404.html", ROOT/"robots.txt", ROOT/"assets/favicon.svg", ROOT/"assets/t0n1n0-og.png"]:
